...
const DashboardLayout = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      <Sidebar isOpen={sidebarOpen} onClose={() => setSidebarOpen(false)} onConnectClick={() => { console.log("setConnectModalOpen called from Sidebar"); setConnectModalOpen(true); }} />
      <div className="flex flex-col flex-1 overflow-hidden lg:ml-[210px]">
        <TopBar onMenuClick={() => setSidebarOpen(true)} searchQuery={searchQuery} onSearchChange={setSearchQuery} unreadCount={unreadCount} onBellClick={() => setNotifOpen(prev => !prev)} onConnectClick={() => setConnectModalOpen(true)} onSupportClick={() => setSupportModalOpen(true)} currentRoute="/dashboard" />
